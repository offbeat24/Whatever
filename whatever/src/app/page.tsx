    ...
    <>
      ...
      <main className='absolute top-0 left-0 w-full'>
        <div className='flex flex-col h-screen'>
          ...
          <Link href="/random">
            <section className='flex laptop:h-[3.25rem] tablet-l:h-[3rem] tablet:h-[2.5rem] mobile:h-[2.5rem] laptop:text-[1.5625rem] tablet-l:text-[1.25rem] tablet:text-[1.25rem] mobile:text-[1rem] text-white bg-orange-o2 justify-center items-center text-center fixed bottom-0 left-0 w-full'>
